	...
	public static void main(String[] args)
	{
		...
		while (true)
		{
			...
			try
			{
				...
				{
					System.out.println("Invalid habitat number. Please enter a number between 0 and 5.");
				}
			} catch (NumberFormatException e)
			{
				System.out.println("Invalid input. Please enter a number between 0 and 5 or 'exit' to quit.");
			}
		}
